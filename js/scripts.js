...
const myCarouselElement2 = document.querySelector('#demo2')
const myCarouselElement3 = document.querySelector('#demo3')
const myCarouselElement4 = document.querySelector('#demo4')
